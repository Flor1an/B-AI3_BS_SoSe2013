...
public class SimulationEnv {
	...
	/**
	 * Anzahl an erzeugten Prozessen (1 reicht f�r die Auswertung der Seitenfehlerrate)
	 */
	...
	public static void main(String[] args) {
		...
		// Testausgaben erw�nscht? Wenn true, dann simulationTime auf max. 100 ms setzen!
		os.setTestMode(true); 
